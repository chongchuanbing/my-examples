...
@EnableJpaRepositories(basePackages = "com.corbin.examples.jpa.atomikos.dao.primary",  //注意这里
...
public class JPAPrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManager() throws Throwable {
        ...
        //这里要修改成主数据源的扫描包
        entityManager.setPackagesToScan("com.corbin.examples.jpa.atomikos.entity.primary");
